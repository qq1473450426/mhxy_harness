...
class HarnessDesktop(QMainWindow):
    def __init__(self):
        ...
        self.settings={}; self.runner=None; self.wm=None; self.windows=[]; self.bound=None; self._train_result=None
    ...
    def _load_backend(self):
        try:
            ...
            load_env(); self.settings=load_config("config.yaml"); self.runner=GameRunner(self.settings); self.wm=WindowManager(); self._log("Harness 核心已加载"); self.refresh_windows()
    ...
    def optimize(self):
        self.opt_btn.setEnabled(False); self._train_result=None; self.train_log.appendPlainText("训练开始...")
